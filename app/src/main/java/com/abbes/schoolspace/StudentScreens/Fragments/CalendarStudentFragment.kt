 ...
 * Use the [CalendarStudentFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CalendarStudentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calendar_student, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      newRecylerview.setHasFixedSize(true)
        ...
        val retrofitData = retrofitBuilder.getTimetableByStudentId(uuid.toString())
...
/*  else
    ...
    companion object {
         ...
         * @return A new instance of fragment CalendarStudentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CalendarStudentFragment().apply {
