 ...
 * Use the [verifiedteacher.newInstance] factory method to
 * create an instance of this fragment.
 */
class verifiedteacher : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_verifiedteacher, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment verifiedteacher.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            verifiedteacher().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fullname = arrayOf("Beyram ayadi","Mohammed Abbes","Mourad Hedhli","Ferjani Sassi")
        email =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mourad.hedhli@gmail.com","ferjani.sassi@gmail.com")
        password =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn","ferjani.sassi@gmail.com")
        confirmed = arrayOf(true,false,true,false)
    ...
    private fun getUserdata() {
        ...
        Log.e("getusersdata",newArrayList2.toString())


        for(i in newArrayList2.indices){
            if(newArrayList2[i].confirmed==true){
    ...
    private fun getUsers(){
        ...
        retrofitData.enqueue(object : Callback<UsersInf> {
            override fun onResponse(
                ...
                Toast.makeText(context, response.code().toString()+" "+response.message().toString(),Toast.LENGTH_LONG).show()
               // Toast.makeText(applicationContext, response.code().toString()+" ", Toast.LENGTH_LONG).show()
                if(response.isSuccessful){
                    newArrayList2 = response.body()!!
                    Log.e("getusers",newArrayList2.toString())
                    for(i in newArrayList2.indices){
                        if(newArrayList2[i].confirmed==true && newArrayList2[i].roles[0]=="63862832351815a82140b1bf"){
                            Log.e("beyraam",i.toString())
                            //val student = UserInfo(fullname[i],email[i], password[i],confirmed[i])
                            newArrayList3.add(newArrayList2[i])}
                    }
