 ...
 * Use the [notverifiedteacher.newInstance] factory method to
 * create an instance of this fragment.
 */
class notverifiedteacher : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_notverifiedteacher, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment notverifiedteacher.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            notverifiedteacher().apply {
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    for(i in newArrayList2.indices){
                        if(newArrayList2[i].confirmed==false && newArrayList2[i].roles[0]=="63862832351815a82140b1bf"){
