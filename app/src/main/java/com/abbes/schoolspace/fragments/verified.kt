...
class verified : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fullname = arrayOf("Beyram ayadi","Mohammed Abbes","Mourad Hedhli")
        email =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mourad.hedhli@gmail.com")
        password =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn")
        confirmed = arrayOf(true,false,true)
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    for(i in newArrayList2.indices){
                        if(newArrayList2[i].confirmed==true && newArrayList2[i].roles[0]=="63862832351815a82140b1c2"){
