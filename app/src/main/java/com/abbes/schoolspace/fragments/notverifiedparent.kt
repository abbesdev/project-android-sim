 ...
 * Use the [notverifiedparent.newInstance] factory method to
 * create an instance of this fragment.
 */
class notverifiedparent : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_notverifiedparent, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment notverifiedparent.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            notverifiedparent().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fullname = arrayOf("Beyram ayadi","Mohammed Abbes","Mourad Hedhli","Mourad Hedhli","Mourad Hedhli","Mourad Hedhli")
        email =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mourad.hedhli@gmail.com","mourad.hedhli@gmail.com","mourad.hedhli@gmail.com","mourad.hedhli@gmail.com")
        password =  arrayOf("beyram.ayadi@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn","mohammed.abbes@esprit.tn")
        confirmed = arrayOf(true,false,true,true,false,true)
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    for(i in newArrayList2.indices){
                        if(newArrayList2[i].confirmed==false && newArrayList2[i].roles[0]=="638628bb762241552fd5b1a4"){
